 ...
 */
class Utils {
    /** Returns the applications base path. This path can be used for HTTP-Links or similar */
    ...
    public static function getServerDocumentRoot() { return @$_SERVER['DOCUMENT_ROOT']; }
